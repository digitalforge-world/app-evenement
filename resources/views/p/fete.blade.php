...
@section('content')
    <div class="container mt-5 pt-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img src="{{ asset('asset/fête/undraw_beer-celebration_ytqf.png')}}" alt="Image descriptive" class="img-fluid rounded">
            </div>
            <!-- Colonne de texte à gauche -->
            <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                <div class="text-center">
                    <h2>Célébrez chaque moment comme s'il était unique</h2>
                </div>
                <div>
                    ...
                    <div class="row gy-6">
                        ...
                        <div class="col-md-3 my-3 col-6 ">
                            ...
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/evala.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/tables.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/independance.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/tamtams.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/Tradition.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/fête/adifo.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
