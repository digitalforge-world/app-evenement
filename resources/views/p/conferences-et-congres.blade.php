...
@section('title', 'confernces-et-congres')
@section('content')
    <div class="container mt-5 pt-5">
        <div class="row align-items-center">
            <!-- Colonne d'image à droite -->
            <div class="col-md-6">
                <img src="{{ asset('asset/conference/undraw_conference-speaker_balr.png')}}" alt="Image descriptive" class="img-fluid rounded">
            </div>
            <!-- Colonne de texte à gauche -->
            <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                <div class="text-center">
                    <h2>Le rendez-vous des esprits visionnaires</h2>
                </div>
                <div>
                    ...
                    <div class="row gy-6">
                        ...
                        <div class="col-md-3 my-3 col-6 ">
                            ...
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/assemblé.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/icc.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/togod.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/afriquestartup.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/conferences.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/conference/congres.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
