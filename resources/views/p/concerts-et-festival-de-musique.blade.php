...
@section('title', 'concerts-et-festival-de-musique')
@section('content')
    <div class="container mt-5 pt-5">
        <div class="row align-items-center">
            <!-- Colonne d'image à droite -->
            <div class="col-md-6">
                <img src="{{ asset('asset/photo/undraw_medicine_hqqg.png')}}" alt="Image descriptive" class="img-fluid rounded">
            </div>
            <!-- Colonne de texte à gauche -->
            <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                <div class="text-center">
                    <h2>La musique en live, l'émotion en direct</h2>
                </div>
                <div>
                    ...
                    <div class="row gy-6">
                        ...
                        <div class="col-md-3 my-3 col-6 ">
                            ...
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/consult.png') }}" class="card-img-top w-100 h-100 object-fit-cover " alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/tension.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/etat.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/piquer.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/infirmiere.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photo/sante.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
