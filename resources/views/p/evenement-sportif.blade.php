...
@section('title', 'evenement-sportif')
@section('content')
    <div class="container mt-5 pt-5">
        <div class="row align-items-center">
            <!-- Colonne d'image à droite -->
            <div class="col-md-6">
                <img src="{{ asset('asset/photos/undraw_goal_rulh.png')}}" alt="Image descriptive" class="img-fluid rounded">
            </div>
            <!-- Colonne de texte à gauche -->
            <div class="col-md-6 d-flex justify-content-center align-items-center flex-column">
                <div class="text-center">
                    <h2>Plus fort, plus loin, ensemble</h2>
                </div>
                <div>
                    ...
                    <div class="row gy-6">
                        ...
                        <div class="col-md-3 my-3 col-6 ">
                            ...
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/basket.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/vollet.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/handb.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/vitesse.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/cyclisme.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
                        ...
                        <div class="col-md-3 my-3 col-6">
                            <div class="card event-item">
                                <img src="{{ asset('asset/photos/sporttop.png') }}" class="card-img-top w-100 h-100 object-fit-cover" alt="">
                                <div class="card-body">
                                    <h3 class="card-title text-center">hello</h3>
