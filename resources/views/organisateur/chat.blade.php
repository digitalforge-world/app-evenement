...
@section('content')
    <div class="container">
        <div class="container px-4 py-2 h-100">
                    ...
                    <form action="#" class="bg-light" method="POST" enctype="multipart/form-data">
                        <div class="input-group ">
                            <input type="text" placeholder="Type a message" aria-describedby="button-addon2"
                                class="form-control rounded-0 border-0 py-4 bg-secondary-subtle">
                            <div class="input-group-append">
                                <button id="button-addon2" type="submit" class="btn btn-link bg-secondary-subtle"> <i
